...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["feature-user-user-module"], {
  ...
  function srcAppFeatureUserUserRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _customer_user_customer_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./customer-user/customer-user.component */
    "./src/app/feature/user/customer-user/customer-user.component.ts");

    var routes = [{
      path: 'customer-user',
      component: _customer_user_customer_user_component__WEBPACK_IMPORTED_MODULE_2__["CustomerUserComponent"]
    }];
